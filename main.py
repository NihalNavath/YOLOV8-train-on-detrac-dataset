...
class SpeedDetector:
     ...
     def detect(self):
          ...
          out = cv2.VideoWriter(f"{self.save_file}/generated_output.avi", fourcc, 20.0, (1280, 960))
                    ...
                    for result in results:
                         ...
                         for box in boxes:
                              ...
                              if not self.args.hide:
                                   ...
                                   frame = draw.draw_text_with_background(frame, f"Busses: {info['bus']}", (0, 90))
     ...
     def create_record(
          ...
          """
          with open(self.save_file + f"/speed_result.txt", "w") as f:
               for id in info:
